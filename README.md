...
This version is intended for architectural review and local experimentation. It is not production-ready and does not provide a security sandbox. See [docs/known-limitations.md](docs/known-limitations.md).
